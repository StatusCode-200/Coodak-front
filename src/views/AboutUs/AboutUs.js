...
<img className=" img-fluid" src="http://pyramidaal.com/wp-content/uploads/2019/03/aboutus-org.jpg" alt="card image" />
      ...
      <section  className="team" className="pb-5">
        ...
        <p id="summary">Coodak, It is a Collaborative development environment for front-end developers & data structure learner, to show off their work as well as improve their data structure skills <br />
          ...
          <h6 className="section-title h4">OUR TEAM</h6>
          <div className="row">
                  ...
                  <div className="backside">
                    <div className="card">
                      <div className="card-body text-center mt-4">
                        <h4 className="card-title">Adnan Abu Muamar</h4>
                        <p className="card-text">A Full Stack Web Developer, 23 years old Live In Gazza and has a BSc in Computer Engineering field.</p>
              ...
              <div className="image-flip" >
                <div className="mainflip flip-0">
                  <div className="frontside">
                    <div className="card">
                      <div className="card-body text-center">
                        <p><img className=" img-fluid" src="https://avatars0.githubusercontent.com/u/38500521?s=400&u=5e28fbf9ba9923902793bb1f79500c127a836cc9&v=4" alt="card image" /></p>
              ...
              <div className="image-flip" >
                <div className="mainflip flip-0">
                  <div className="frontside">
                    <div className="card">
                      <div className="card-body text-center">
                        <p><img className=" img-fluid" src="https://avatars0.githubusercontent.com/u/64354787?s=400&u=42ce914cbb8f9dc5ef4e0c884e6027dc715125ad&v=4" alt="card image" /></p>
                        <h4 className="card-title">Mohammad Samara</h4>
                        <p className="card-text">Web Developer.</p>
                        <a href="https://www.fiverr.com/share/qb8D02" className="btn btn-primary btn-sm"><i className="fa fa-info"></i></a>
                      </div>
                    </div>
                  ...
                  <div className="backside">
                    <div className="card">
                      <div className="card-body text-center mt-4">
                        <h4 className="card-title">Mohammad Samara</h4>
                        <p className="card-text">A Full Stack JS Web Developer, 24 years old Live in Irbid and  has a BSc Degree in Civil Engineering  field .</p>
                        <ul className="list-inline">
                          <li className="list-inline-item">
                            <a className="social-icon text-xs-center" target="_blank" href="https://www.fiverr.com/share/qb8D02">
                              <i className="fa fa-facebook"></i>
              ...
              <div className="image-flip" >
                <div className="mainflip flip-0">
                  <div className="frontside">
                    <div className="card">
                      <div className="card-body text-center">
                        <p><img className=" img-fluid" src="https://avatars0.githubusercontent.com/u/65109422?s=400&u=208e47e22c70f07db790b16dc34f297123195c08&v=4" alt="card image" /></p>
