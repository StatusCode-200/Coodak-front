...
function AboutUs() {
  return (
    <>
<img class=" img-fluid" src="http://pyramidaal.com/wp-content/uploads/2019/03/aboutus-org.jpg" alt="card image" />
      ...
      <section id="team" class="pb-5">
        ...
        <p id="summary">Coodak, It is a Collaborative development environment for front-end developers & data structure learner, to show off their work as well as improve their data structure skills <br />
          ...
          <h6 class="section-title h4">OUR TEAM</h6>
          <div class="row">
                  ...
                  <div class="backside">
                    <div class="card">
                      <div class="card-body text-center mt-4">
                        <h4 class="card-title">Adnan Abu Muamar</h4>
                        <p class="card-text">A Full Stack Web Developer, 23 years old Live In Gazza and has a BSc in Computer Engineering field.</p>
